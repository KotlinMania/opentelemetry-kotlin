# opentelemetry-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fopentelemetry--kotlin-blue.svg)](https://github.com/KotlinMania/opentelemetry-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/opentelemetry-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/opentelemetry-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/opentelemetry-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/opentelemetry-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry).

**Original Project:** This port is based on [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
> The text below is reproduced and lightly edited from [`https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:opentelemetry-kotlin:0.1.0-SNAPSHOT")
}
```
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
