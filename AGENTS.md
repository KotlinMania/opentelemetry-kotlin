...
This file is the quick-reference operating contract for opentelemetry-kotlin. The longer
...
opentelemetry-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`opentelemetry`](https://crates.io/crates/opentelemetry). Upstream Rust is the behavioral oracle while the
