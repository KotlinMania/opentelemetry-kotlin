...
kotlin {
    ...
    val xcf = XCFramework("Opentelemetry")

    macosArm64 {
        binaries.framework { baseName = "Opentelemetry"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Opentelemetry"; xcf.add(this) }
    }
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.opentelemetry"
    }

    android {
        namespace = "io.github.kotlinmania.opentelemetry"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "opentelemetry-kotlin", version.toString())

    pom {
        name.set("opentelemetry-kotlin")
        description.set("Kotlin Multiplatform port of open-telemetry/opentelemetry-rust - OpenTelemetry API for Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/opentelemetry-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/opentelemetry-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/opentelemetry-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/opentelemetry-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleOpentelemetryXCFramework",
    "assembleOpentelemetryDebugXCFramework",
    "assembleOpentelemetryReleaseXCFramework",
    "assembleDebugIosFatFrameworkForOpentelemetryXCFramework",
    "assembleReleaseIosFatFrameworkForOpentelemetryXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForOpentelemetryXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForOpentelemetryXCFramework",
    "assembleDebugMacosFatFrameworkForOpentelemetryXCFramework",
    "assembleReleaseMacosFatFrameworkForOpentelemetryXCFramework",
    "assembleDebugTvosFatFrameworkForOpentelemetryXCFramework",
    "assembleReleaseTvosFatFrameworkForOpentelemetryXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForOpentelemetryXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForOpentelemetryXCFramework",
    "assembleDebugWatchosFatFrameworkForOpentelemetryXCFramework",
    "assembleReleaseWatchosFatFrameworkForOpentelemetryXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForOpentelemetryXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForOpentelemetryXCFramework",
